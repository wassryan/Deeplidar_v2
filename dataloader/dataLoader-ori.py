...
def dataloader(filepath):
    ...
    temp = filepath # /nfs-data/zhengk_data/Depth_Completion_Evaluation/
    temp1 = '/nfs-data/zhengk_data/raw_data/'
    # filepathl = temp + 'data_depth_velodyne/train'
    # filepathd = temp + 'data_depth_annotated/train'
    # filepathgt = temp + 'gt/out/train'
    filepathl = temp + 'train'
    filepathd = temp + 'train'
    filepathgt = temp + 'gt/out/train'

    seqs = [seq for seq in os.listdir(filepathl) if seq.find('sync') > -1] # ['2011_09_26_drive_0056_sync', ...]
    ...
    for seq in seqs:
        # '/nfs-data/zhengk_data/raw_data/' + 'gt/out/train' + ''
        ...
        # '/nfs-data/zhengk_data/Depth_Completion_Evaluation/' + 'train' + '2011_09_26_drive_0056_sync' + 'proj_depth/velodyne_raw/image_02'
