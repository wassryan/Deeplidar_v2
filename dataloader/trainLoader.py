...
class myImageFloder(data.Dataset):
    def __init__(self, left,sparse,depth,training,
        ...
        self.left = left # rgb
        self.sparse = sparse # lidar depth
        self.input = depth # surface normal(gt depth)
        self.loader = loader
    ...
    def __getitem__(self, index):
        ...
        sparse2 = self.sparse[index]
        # left_img = self.loader(left)
        left_img = skimage.io.imread(left) # my_function
        ...
        sparse,mask = self.sloader(sparse2)
        ...
        # return data_in1,sparse,mask,params
