...
class depthCompletionNew(nn.Module):
    ...
    def forward(self, left,sparse,mask):
        ...
        outN,tempCatN = self.outN_block(normal_in, sparse, maskC) # maskC is confidence mask
        ...
        if self.training:
            ...
            return outC, outN, maskC3, maskN3, maskC # zk_add, add last argument for confidence mask
