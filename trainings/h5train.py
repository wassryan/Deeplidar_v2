# CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7,8 python h5train.py --loadmodel D_model_6.tar --epochs 20 --batch_size 8 --gpu_nums 8
...
parser.add_argument('--savemodel', default='Final_model', help='save model')
...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        #SAVE
        if epoch % 1 == 0:
            savefilename = args.savemodel + str(epoch+9) +  '.tar'
            torch.save({
	            'epoch': epoch,
